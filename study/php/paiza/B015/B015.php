...
class SegmentClass
{
    public $userDefaultSegments = array();
    public $userSymmetrySegments = array();
    public $userRotateSegments = array();

    public $baseSegments = array(
    ...
    public $resultFlag = array(
        'default'  => array('A' => 0, 'B' => 0),
        'symmetry' => array('A' => 0, 'B' => 0),
        'rotate'   => array('A' => 0, 'B' => 0),
    );

    public function __construct()
    {
        $this->userDefaultSegments['A'] = explode(' ', $this->getStdin());
        $this->userDefaultSegments['B'] = explode(' ', $this->getStdin());
    }
    ...
    public function generateSymmetryPosition()
    {
    ...
    public function changeSegments($change, $base, $segA, $numA, $segB, $numB)
    {
    ...
    public function generateRotatePosition()
    {
